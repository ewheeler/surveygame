...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Crew.survey'
        db.add_column('txtgame_crew', 'survey', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['txtgame.Survey']), keep_default=False)

        # Adding field 'Crew.current_question'
        db.add_column('txtgame_crew', 'current_question', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['txtgame.Question']), keep_default=False)
