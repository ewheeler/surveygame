...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Puzzle'
        db.create_table('txtgame_puzzle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('txtgame', ['Puzzle'])


    def backwards(self, orm):
        
        # Deleting model 'Puzzle'
        db.delete_table('txtgame_puzzle')
    ...
    models = {
        ...
        'txtgame.crew': {
            ...
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'crews'", 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        'txtgame.puzzle': {
