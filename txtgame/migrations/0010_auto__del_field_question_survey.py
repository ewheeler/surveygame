...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('txtgame_question', 'survey_id')


    def backwards(self, orm):
        
        # We cannot add back in field 'Question.survey'
        raise RuntimeError(
            "Cannot reverse this migration. 'Question.survey' and its values cannot be restored.")
