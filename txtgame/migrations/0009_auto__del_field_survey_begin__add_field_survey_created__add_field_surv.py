...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Survey.begin'
        db.delete_column('txtgame_survey', 'begin')

        # Adding field 'Survey.created'
        db.add_column('txtgame_survey', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 9, 23, 37, 29, 797354)), keep_default=False)

        # Adding field 'SurveyGame.begin'
        db.add_column('txtgame_surveygame', 'begin', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 5, 9, 23, 37, 37, 357237), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'Survey.begin'
        raise RuntimeError(
            "Cannot reverse this migration. 'Survey.begin' and its values cannot be restored.")

        # Deleting field 'Survey.created'
        db.delete_column('txtgame_survey', 'created')

        # Deleting field 'SurveyGame.begin'
        db.delete_column('txtgame_surveygame', 'begin')
