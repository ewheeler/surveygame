...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SurveyGame'
        db.create_table('txtgame_surveygame', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('current_question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['txtgame.Question'])),
        ))
        db.send_create_signal('txtgame', ['SurveyGame'])

        # Adding M2M table for field crew on 'SurveyGame'
        db.create_table('txtgame_surveygame_crew', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('surveygame', models.ForeignKey(orm['txtgame.surveygame'], null=False)),
            ('crew', models.ForeignKey(orm['txtgame.crew'], null=False))
        ))
        db.create_unique('txtgame_surveygame_crew', ['surveygame_id', 'crew_id'])

        # Adding M2M table for field current_survey on 'SurveyGame'
        db.create_table('txtgame_surveygame_current_survey', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('surveygame', models.ForeignKey(orm['txtgame.surveygame'], null=False)),
            ('survey', models.ForeignKey(orm['txtgame.survey'], null=False))
        ))
        db.create_unique('txtgame_surveygame_current_survey', ['surveygame_id', 'survey_id'])

        # Deleting field 'Crew.current_question'
        db.delete_column('txtgame_crew', 'current_question_id')
        ...
        # Adding field 'ReciprocalAccuracy.game'
        db.add_column('txtgame_reciprocalaccuracy', 'game', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['txtgame.SurveyGame']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SurveyGame'
        db.delete_table('txtgame_surveygame')

        # Removing M2M table for field crew on 'SurveyGame'
        db.delete_table('txtgame_surveygame_crew')

        # Removing M2M table for field current_survey on 'SurveyGame'
        db.delete_table('txtgame_surveygame_current_survey')

        # We cannot add back in field 'Crew.current_question'
        raise RuntimeError(
            "Cannot reverse this migration. 'Crew.current_question' and its values cannot be restored.")
        ...
        # We cannot add back in field 'ReciprocalAccuracy.crew'
        raise RuntimeError(
            "Cannot reverse this migration. 'ReciprocalAccuracy.crew' and its values cannot be restored.")

        # Deleting field 'ReciprocalAccuracy.game'
        db.delete_column('txtgame_reciprocalaccuracy', 'game_id')
    ...
    models = {
        ...
        'txtgame.reciprocalaccuracy': {
            ...
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['txtgame.SurveyGame']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'txtgame.surveygame': {
            'Meta': {'object_name': 'SurveyGame'},
            'crew': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['txtgame.Crew']", 'symmetrical': 'False'}),
