...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TwoOptionQuestion.text'
        db.delete_column('txtgame_twooptionquestion', 'text')

        # Adding field 'TwoOptionQuestion.text_second_person'
        db.add_column('txtgame_twooptionquestion', 'text_second_person', self.gf('django.db.models.fields.CharField')(default='foo', max_length=160), keep_default=False)

        # Adding field 'TwoOptionQuestion.text_third_person'
        db.add_column('txtgame_twooptionquestion', 'text_third_person', self.gf('django.db.models.fields.CharField')(default='foo', max_length=160), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TwoOptionQuestion.text'
        db.add_column('txtgame_twooptionquestion', 'text', self.gf('django.db.models.fields.CharField')(default='foo', max_length=160), keep_default=False)

        # Deleting field 'TwoOptionQuestion.text_second_person'
        db.delete_column('txtgame_twooptionquestion', 'text_second_person')

        # Deleting field 'TwoOptionQuestion.text_third_person'
        db.delete_column('txtgame_twooptionquestion', 'text_third_person')
